...
import diContainer, { createManager } from './proxy-container';
...
describe('proxyContainer', () => {
  ...
  it('calls initializer to resolve cyclic dependencies', () => {
    type Node = {
      child: Node,
      parent: Node,
    }
    ...
    const container = diContainer<Container>({
      ...
      childItem: ({ parentItem }) => ({ child: null, parent: parentItem }),
    });
